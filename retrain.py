...
IMAGE_SIZE = 256
#IMAGE_DIRECTORY = './images/data/training_set'
#IMAGE_DIRECTORY = './images/PetImages'
IMAGE_DIRECTORY = './images/mimi_set'
...
model.fit(training_images, training_labels, batch_size = 100, epochs = 100, verbose = 1)
